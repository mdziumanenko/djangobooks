...
def get_books_read_by_month(username):
    """Get books read by user on per month basis.
    :param: str username for which books needs to be returned
...
def get_books_read(username):
    ...
    :param: str username for whom the book records should be returned :return: list of dict of books read \
