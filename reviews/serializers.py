...
class ContributorSerializer(serializers.ModelSerializer):
    # list of contributions made by a specific contributor
    bookcontributor_set = ContributionSerializer(read_only=True, many=True)
    # use method we defined in Contributor class. For this to work, we need to
    # set this as a read-only field
